...
public class RecordUtils {
     ...
     */
    public static <T extends Record> T init(@Nonnull final Class<T> recordClass, @Nonnull final Map<String, Object> fieldsToValues) {
        ...
        // Set to keep track of fields not yet ste
        final Set<String> fieldsNotSet = new HashSet<>(recordFields.keySet());

        final AtomicInteger i = new AtomicInteger(0);
        recordFields.forEach((name, component) -> {
            final Object fieldValue = Optional.ofNullable(fieldsToValues.get(name))
                                              .orElse(null);
        ...
        // If there are keys left in the set, throw an exception listing them as the user supplied invalid fields
    ...
    /**
     * Returns the default value for a record component. If the component is a primitive, the default value is 0. If the
     * component is an object reference, the default value is null.
     *
