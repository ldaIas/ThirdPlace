...
public class ThirdPlaceDatabaseServiceTests {
    ...
    private static final List<TableColumnType> TEST_COLUMNS = List.of(
            new TableColumnType("id", "INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY UNIQUE"),
    ...
    /**
     * Test ensuring that we can update records correctly:
     * - Inserts 5 records
    ...
    void testUpdateData_Success() {
        ...
        final DatabaseServiceResults<UpdateResult> updateRes = staticDbService.updateRecord(tableName,
                List.of(column), List.of(filter));
